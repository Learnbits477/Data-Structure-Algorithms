# [Articulation Point - II](https://www.geeksforgeeks.org/problems/articulation-point2616/1)
...
> [!NOTE]
> The graph may be disconnected. If no such point exists, return `{-1}`.

## Examples

**Input:** V = 5, edges[][] = [[0, 1], [1, 4], [4, 3], [4, 2], [2, 3]]
**Output:** [1, 4]
**Explanation:** Removing the vertex 1 or 4 will disconnect the graph.
