# [Split an Array into Two Equal Sum Subarrays](https://www.geeksforgeeks.org/problems/split-an-array-into-two-equal-sum-subarrays/1)

### Difficulty: Easy  Accuracy: 54.45%  ubmissions: 44K+ Points:2
---
## Problem Description
