...
class Solution {
public:
    long long maxSumTrionic(vector<int>& nums) {  // Changed from maxSumTrionicSubarray
        int n = nums.size();
        int p, q, j;
...
int main() {
    ...
    // Example 1
    vector<int> nums1 = {0,-2,-1,-3,0,2,-1};
    cout << "Example 1 Output: " << sol.maxSumTrionic(nums1) << endl; 
    // Expected: -4

    // Example 2
    vector<int> nums2 = {1,4,2,7};
    cout << "Example 2 Output: " << sol.maxSumTrionic(nums2) << endl; 
    // Expected: 14
