...
int main() {
    ...
    cout << "Test 1: " << sol.longestBalanced(nums1) << " Expected: 4" << endl;
    
    // Example 2
    vector<int> nums2 = {3,2,2,5,4};
    cout << "Test 2: " << sol.longestBalanced(nums2) << " Expected: 5" << endl;
    
    // Example 3
    vector<int> nums3 = {1,2,3,2};
    cout << "Test 3: " << sol.longestBalanced(nums3) << " Expected: 3" << endl;
