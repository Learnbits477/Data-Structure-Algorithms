...
![Acceptance: 84.7%](https://img.shields.io/badge/Acceptance-84.7%25-brightgreen?style=for-the-badge)
![Topic: Math](https://img.shields.io/badge/Math-cyan?style=for-the-badge)
![Topic: Dynamic Programming](https://img.shields.io/badge/Dynamic%20Programming-cyan?style=for-the-badge)
...
## 📐 Constraints
- $1 \le \text{num1} \le \text{num2} \le 10^5$

## ⏱️ Expected Complexities
| Complexity | Expected |
|:----------:|:--------:|
| Time | $\mathcal{O}((N_2 - N_1) \cdot \log_{10}(N_2))$ |
| Space | $\mathcal{O}(1)$ |
