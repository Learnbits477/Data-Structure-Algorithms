...
**Difficulty:** Hard  
**Topics:** Binary Search, Sorting, Greedy, Two Pointers  
...
> **Note:** The Manhattan Distance between two cells `(xi, yi)` and `(xj, yj)` is `|xi - xj| + |yi - yj|`.
...
> **Output:** `2`  
> **Explanation:** Select all four points. The minimum distance is between adjacent corners: `|0-2| + |0-0| = 2`.
